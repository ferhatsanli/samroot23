...
## Status
NEEDS INPUT — remote command `2026-08-13-cyb4-probe-006` checked all four authorized local locations; CYB4 is absent.
...
## Safety
Place input in ignored `firmware_inputs/`; offline analysis only, never flash.
